...
# Backward compatibility route for old image URLs
@router.get("/images/{filename}")
async def get_image_legacy(filename: str):
    """
    Legacy image serving route for backward compatibility
    Serves images directly for old URLs
    """
    import os
    ...
    try:
        ...
        logger.error(f"Failed to serve legacy image: {str(e)}")
